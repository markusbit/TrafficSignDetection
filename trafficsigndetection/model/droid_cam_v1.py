...
# --------------------------------------#
# Wähle hier deinen Input aus:         #
# --------------------------------------#

# A) DroidCam über Windows Webcam-Treiber (z.B. Kamera Index 1):
cap = cv2.VideoCapture(1)

# B) Oder: DroidCam IP-Stream (Handy zeigt IP an, z.B. 192.168.0.123)
# cap = cv2.VideoCapture("http://192.168.0.123:4747/video")
...
while True:
    ret, frame = cap.read()
    if not ret:
        print("Kein Bild erhalten. Beende...")
        break
